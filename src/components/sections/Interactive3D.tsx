            ...
            >
              ...
              >
                ...
                >
                  ...
                  <div 
                    className="absolute inset-0 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-[3rem] shadow-2xl border-[10px] border-gray-950"
                    style={{
                      transformStyle: 'preserve-3d',
                    }}
                  >
                    ...
                    <div 
                      ...
                      style={{
                        ...
                        border: '10px solid rgba(3, 7, 18, 0.95)',
                      }}
                    ></div>
                    
                    {/* Front Screen */}
                    <div 
                      className="absolute inset-[0.4rem] bg-black rounded-[2.8rem] overflow-hidden"
                      style={{
                    ...
                    >
                      ...
                      <div className="absolute top-2 left-1/2 transform -translate-x-1/2 w-32 h-8 bg-black rounded-full z-20 shadow-lg">
                        <div className="absolute inset-0 flex items-center justify-center">
                          <div className="w-4 h-4 bg-gray-700 rounded-full"></div>
                          <div className="absolute right-3 w-1 h-1 bg-gray-600 rounded-full"></div>
                        </div>
                      </div>
                      ...
                      <div className="absolute top-0 left-0 right-0 h-10 z-10 flex items-center justify-between px-6 pt-2">
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          <svg className="w-4 h-3 text-white" fill="currentColor" viewBox="0 0 24 16">
                      ...
                      <div className="absolute inset-0 pt-10 flex flex-col">
                        ...
                        <div className="bg-[#17212b] px-4 py-3 flex items-center gap-3 border-b border-[#0e1621]">
                          ...
                          <div className="flex-1">
                            <p className="text-white text-sm font-semibold flex items-center gap-2">
                              Puldor Bot
                              <span className="text-[#0088cc] text-xs">✓✓</span>
                            </p>
                            <p className="text-[#7c8a96] text-xs">был(а) недавно</p>
                          </div>
                          <div className="flex items-center gap-3">
                            <svg className="w-5 h-5 text-[#7c8a96]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        {/* Chat Messages Area */}
                        <div className="flex-1 bg-[#0e1621] p-4 space-y-3 overflow-y-auto">
                          ...
                          {selectedFeature === 'voice' && (
                            <div className="space-y-3 animate-fade-in">
                              ...
                              <div className="flex justify-end">
                                <div className="bg-[#0088cc] rounded-lg rounded-tr-none px-4 py-2.5 max-w-[80%]">
                                  <div className="flex items-center gap-2">
                                    ...
                                    <div className="flex-1">
                                      <p className="text-white text-xs font-medium mb-1">Голосовое сообщение</p>
                                      <div className="flex items-center gap-1">
                                        {[...Array(20)].map((_, i) => (
                                          <div
                                            key={i}
                                            ...
                                            style={{
                                              height: `${6 + Math.sin(i * 0.5) * 4 + Math.random() * 3}px`,
                                            }}
                                          />
                                        ))}
                                      </div>
                                      <p className="text-white/70 text-[10px] mt-1 text-right">0:03</p>
                                    </div>
                                  </div>
                                </div>
                              </div>
                          ...
                          {selectedFeature === 'ai' && (
                            <div className="space-y-3 animate-fade-in">
                              {/* User message */}
                              <div className="flex justify-end">
                                <div className="bg-[#0088cc] rounded-lg rounded-tr-none px-4 py-2.5 max-w-[85%]">
                                  <p className="text-white text-xs">"Потратил 5000 сумов на обед"</p>
                                  <p className="text-white/70 text-[10px] mt-1 text-right">12:34</p>
                                </div>
                              </div>
                              {/* Bot processing */}
                              <div className="flex justify-start">
                                <div className="bg-[#182533] rounded-lg rounded-tl-none px-4 py-2.5 max-w-[70%]">
                                  <div className="flex items-center gap-2">
                                    ...
                                    <p className="text-[#7c8a96] text-xs">AI обрабатывает...</p>
                                  </div>
                                </div>
                              </div>
                            </div>
                          ...
                          {selectedFeature === 'categories' && (
                            <div className="space-y-3 animate-fade-in">
                              ...
                              {/* Bot response */}
                              <div className="flex justify-start">
                                <div className="bg-[#182533] rounded-lg rounded-tl-none px-4 py-3 max-w-[80%]">
                                  <div className="flex items-center gap-2 mb-2">
                                    <div className="w-5 h-5 rounded-full bg-[#0088cc]/20 flex items-center justify-center">
                                      <svg className="w-3 h-3 text-[#0088cc]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M5 13l4 4L19 7" />
                                      </svg>
                                    </div>
                                    <p className="text-white text-xs font-medium">✅ Категория: Еда</p>
                                  </div>
                                  <div className="bg-[#0088cc]/10 rounded px-2 py-1.5 mb-2">
                                    <p className="text-[#0088cc] text-sm font-bold">5000 UZS</p>
                                  </div>
                                  <p className="text-[#7c8a96] text-[10px]">12:35</p>
                                </div>
                              </div>
                            </div>
                          )}
                          ...
                          {selectedFeature === 'multilang' && (
                            <div className="space-y-3 animate-fade-in">
                              ...
                              <div className="flex justify-end">
                                <div className="bg-[#0088cc] rounded-lg rounded-tr-none px-4 py-2.5 max-w-[85%]">
                                  <p className="text-white text-xs">🇷🇺 "Потратил 5000 сумов на обед"</p>
                                  <p className="text-white/70 text-[10px] mt-1 text-right">12:30</p>
                                </div>
                              </div>
                              {/* Uzbek */}
                              <div className="flex justify-end">
                                <div className="bg-[#0088cc] rounded-lg rounded-tr-none px-4 py-2.5 max-w-[85%]">
                                  <p className="text-white text-xs">🇺🇿 "Tushlikka 5000 so'm sarfladim"</p>
                                  <p className="text-white/70 text-[10px] mt-1 text-right">12:31</p>
                                </div>
                              </div>
                              {/* English */}
                              <div className="flex justify-end">
                                <div className="bg-[#0088cc] rounded-lg rounded-tr-none px-4 py-2.5 max-w-[85%]">
                                  <p className="text-white text-xs">🇬🇧 "Spent 5000 sums on lunch"</p>
                                  <p className="text-white/70 text-[10px] mt-1 text-right">12:32</p>
                                </div>
                              </div>
                              {/* Bot response */}
                              <div className="flex justify-start">
                                <div className="bg-[#182533] rounded-lg rounded-tl-none px-4 py-2.5 max-w-[70%]">
                                  <p className="text-white text-xs">✅ Все три языка распознаны!</p>
                                  <p className="text-[#7c8a96] text-[10px] mt-1">12:33</p>
                                </div>
                              </div>
                            </div>
                          )}
                          ...
                          {selectedFeature === 'analytics' && (
                            <div className="space-y-3 animate-fade-in">
                              {/* Bot analytics card */}
                              <div className="flex justify-start">
                                <div className="bg-[#182533] rounded-lg rounded-tl-none px-4 py-3 max-w-[85%]">
                                  ...
                                  <div className="space-y-2.5 mb-3">
                                    <div className="flex justify-between items-center">
                                      <span className="text-[#7c8a96] text-xs">Всего расходов:</span>
                                      <span className="text-white font-bold text-sm">450,000 UZS</span>
                                    </div>
                                    <div className="w-full bg-[#0e1621] rounded-full h-2">
                                      <div className="bg-[#0088cc] h-2 rounded-full transition-all duration-500" style={{ width: '65%' }}></div>
                                    </div>
                                    <div className="pt-2 border-t border-[#0e1621]">
                                      <p className="text-[#0088cc] text-xs flex items-center gap-1">
                                        <span>💡</span>
                                        Совет: Можно сэкономить на транспорте
                                      </p>
                                    </div>
                                  </div>
                                  <p className="text-[#7c8a96] text-[10px]">12:40</p>
                                </div>
                              </div>
                            </div>
                          )}
                        ...
                        {/* Telegram Input Area */}
                        <div className="bg-[#17212b] px-4 py-3 border-t border-[#0e1621]">
                          <div className="flex items-center gap-2">
                            <button className="w-8 h-8 rounded-full bg-[#0088cc] flex items-center justify-center">
                              <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 11a7 7 0 01-7 7m0 0a7 7 0 01-7-7m7 7v4m0 0H8m4 0h4m-4-8a3 3 0 01-3-3V5a3 3 0 116 0v6a3 3 0 01-3 3z" />
                              </svg>
                            </button>
                            <div className="flex-1 bg-[#242f3d] rounded-full px-4 py-2">
                              <p className="text-[#7c8a96] text-xs">Сообщение</p>
                            </div>
                            <button className="w-8 h-8 rounded-full bg-[#0088cc] flex items-center justify-center">
                              <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div
                      className="absolute inset-[0.4rem] rounded-[2.8rem] overflow-hidden"
                      style={{
                    ...
                    >
                      ...
                      <div className="absolute inset-0 bg-gradient-to-br from-slate-800/95 via-gray-800/95 to-slate-900/95 rounded-[2.8rem]">
                        ...
                        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10">
                          <svg className="w-14 h-14 md:w-18 md:h-18 text-white/15" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className="absolute top-6 left-1/2 transform -translate-x-1/2 z-20">
                          <div className="relative w-32 h-36 md:w-36 md:h-40 bg-black/95 rounded-3xl shadow-2xl border-2 border-gray-900/80">
                            ...
                            <div className="absolute inset-0 flex items-center justify-center gap-2.5 pt-5">
                              {/* Wide Camera - Largest */}
                              <div className="relative w-10 h-10 md:w-11 md:h-11 rounded-full bg-gradient-to-br from-gray-800 to-black border-2 border-gray-700/60 shadow-2xl">
                              ...
                              {/* Telephoto Camera */}
                              <div className="relative w-9 h-9 md:w-10 md:h-10 rounded-full bg-gradient-to-br from-gray-800 to-black border-2 border-gray-700/60 shadow-2xl">
                                <div className="absolute inset-1 rounded-full bg-gray-950 border border-gray-800/80"></div>
                                <div className="absolute inset-2 rounded-full bg-black"></div>
                        ...
                        <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 text-center z-10">
                          <p className="text-white/25 text-[11px] font-medium tracking-wider">iPhone</p>
                          <p className="text-white/35 text-[9px] tracking-widest mt-0.5">17 PRO</p>
                          <div className="mt-2 flex items-center justify-center gap-4 text-white/20 text-[8px]">
