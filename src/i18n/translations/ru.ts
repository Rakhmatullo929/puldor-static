...
export const ru: Translations = {
  ...
  team: {
    title: 'Команда',
    subtitle: 'Четыре человека, закрывающие продукт от ИИ-ядра до питчинга на английском',
    members: {
      member1: {
        name: 'Member 1',
      ...
      member4: {
        ...
        description:
          'IELTS 8.5. Отвечает за питчинг проекта, продуктовую логику и UX-тексты на английском языке. Коммуникация с жюри конкурса и англоязычными пользователями.',
      },
    },
    links: {
